...
public class Modul_5 extends javax.swing.JFrame {
    ...
    private void loadDatatransaksi() {
         String proyek= "SELECT id FROM proyek"; 
         String karyawan = "SELECT id  FROM karyawan"; 
    ...
    private void updatetransaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatetransaksiActionPerformed
        ...
        try {
          ...
          PreparedStatement ps = conn.prepareStatement(sql);
          ps.setInt(1, Integer.parseInt((String) cmb_idproyek.getSelectedItem().toString()));
          ps.setInt(2, Integer.parseInt(tf_peran.getText()));
          ps.setInt(3, Integer.parseInt((String) cmb_idkaryawan.getSelectedItem().toString()));
          ps.executeUpdate();
