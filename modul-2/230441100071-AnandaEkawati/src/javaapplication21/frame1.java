...
public class frame1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\asus\\Downloads\\unduhan (3).jpeg")); // NOI18N
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, -60, 510, 150));
        ...
        riset.setBackground(new java.awt.Color(51, 0, 51));
        ...
        toping3.setBackground(new java.awt.Color(255, 153, 255));
        topping.add(toping3);
        ...
        toping5.setBackground(new java.awt.Color(255, 153, 255));
        topping.add(toping5);
        ...
        toping1.setBackground(new java.awt.Color(255, 153, 255));
        topping.add(toping1);
        ...
        menu1.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu1);
        ...
        menu2.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu2);
        ...
        menu3.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu3);
        menu3.setText("40.000");
        jPanel1.add(menu3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 70, -1));

        menu4.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu4);
        ...
        menu5.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu5);
        ...
        menu9.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu9);
        menu9.setText("50.000");
        jPanel1.add(menu9, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 240, 70, -1));

        menu10.setBackground(new java.awt.Color(255, 153, 255));
        menu.add(menu10);
        ...
        toping2.setBackground(new java.awt.Color(255, 153, 255));
        topping.add(toping2);
        ...
        toping4.setBackground(new java.awt.Color(255, 153, 255));
        topping.add(toping4);
        ...
        toping6.setBackground(new java.awt.Color(255, 153, 255));
        topping.add(toping6);
    ...
    private void totalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_totalActionPerformed
        ...
        if (pilihanmenu ==false){
            JOptionPane.showMessageDialog(this, "pilih salah satu menunya dong kak!", "Ingattttt!!!", JOptionPane.INFORMATION_MESSAGE);
            return;
        }if (pilihantoping == false){
            JOptionPane.showMessageDialog(this, "pilih salah satu toppingnya dong kak!", "Ingattttt!!!", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
