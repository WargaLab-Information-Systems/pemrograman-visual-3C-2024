...
public class tebak extends javax.swing.JFrame {
    ...
    private void resetGame() {
        ...
        txtTebak.setText(""); // Reset input tebakan untuk input baru
        txtJwbn.setText(""); // Kosongka n jawaban
        txtScore.setText("0"); // Reset skor display
    }
    ...
    private void initComponents() {
        ...
        txtJwbn = new javax.swing.JTextField();
        ...
        ptop.setBackground(new java.awt.Color(0, 0, 102));
        ...
        pCenter.setBackground(new java.awt.Color(0, 0, 255));
        ...
        btnTebak.setBackground(new java.awt.Color(0, 102, 102));
                ...
                .addGroup(pCenterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pCenterLayout.createSequentialGroup()
                        ...
                        .addGroup(pCenterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtJwbn, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pCenterLayout.setVerticalGroup(
            ...
            .addGroup(pCenterLayout.createSequentialGroup()
                ...
                .addGroup(pCenterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtJwbn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(pCenterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        pBottom.setBackground(new java.awt.Color(0, 0, 102));
        ...
        btnKeluar1.setBackground(new java.awt.Color(0, 255, 204));
    ...
    private void btnTebakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTebakActionPerformed
        ...
        try {
            ...
            if (tebakan > angka2) {
                kesempatan--;
                txtJwbn.setText("Angka Tebakan Lebih Besar");
            } else if (tebakan < angka2) {
                kesempatan--;
                txtJwbn.setText("Angka Tebakan Lebih Kecil");
            } else {
                int hasil = kesempatan * 10;
                txtJwbn.setText("Selamat! Anda Menebak: " + tebakan);
                ...
                tebakan = angka1.nextInt(maxrandom) + 1; // Menghasilkan angka tebakan baru
            }
    ...
    private void updateScoreList() {
        ...
        for (int i = 0; i < index; i++) {
            scores[i] = "Name: " + data_score[i][0] + ", Score: " + data_score[i][1];
        }
    ...
    private javax.swing.JTextField txtJwbn;
