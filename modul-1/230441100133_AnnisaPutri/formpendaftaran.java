...
public class formpendaftaran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbMinat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BHQ (Bimbingan Hifdzil Qur'an)", "BBQ (Bimbingan Baca Qur'an)", "JKQ (Jam'iyyah Khatmil Qur'an)", "RSQ (Rebana Sholawat Qur'an)", "BTQ (Bimbingan Tilawatil Qur'an)" }));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if (cbDatasimpan.isSelected()) {
            ...
            JOptionPane.showMessageDialog(this, "Harap konfirmasi Kebenaran Data Dengan Mencentang Kota.", "Error", JOptionPane.ERROR_MESSAGE);
        }
